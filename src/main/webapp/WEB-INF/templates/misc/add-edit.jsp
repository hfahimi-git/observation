...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-10 col-lg-10 px-4 rtl">
            ...
            <form:form action="" method="post" enctype="multipart/form-data" modelAttribute="miscReportItem"
                ...
                <div class="form-row mb-3">
                    <div class="col-md-3">
                        ...
                        <form:select path="luType" id="lu_type" cssClass="form-control custom-select"
                                     ...
                                     items="${typeItems}" itemLabel="value" itemValue="key"/>
...
<%--------------------------------------------------------------------------------------------------------------------%>
                <div class="form-row mb-3">
                    <div class="col-md-11">
                        ...
                        <c:if test="${URI_METHOD.equals('edit') && not empty miscReportItem.filename }">
                            <div>
...
<%--------------------------------------------------------------------------------------------------------------------%>
                <button class="btn btn-primary" type="submit"
                        onclick="return confirm('<fmt:message key="are_you_sure"/>')"><fmt:message
                        key="submit"/></button>
            ...
            <ul class="col-lg-2 col-md-2 internal-menu internal-menu-default float-right">
                ...
                <c:if test="${URI_METHOD.equals('edit')}">
                    ...
                    <%--                    <li><a href="/${URI_CLASS}/detail/${miscReportItem.oid}"><fmt:message key="detail"/></a></li>--%>
                    <li><a href="/${URI_CLASS}/remove/${miscReportItem.oid}"><fmt:message key="remove"/></a></li>
                    <%--                <li><a href="${CONTEXT}/misc-report?board_oid=${miscReportItem.oid}"><fmt:message key="board-periods" /></i></a></li>--%>
                </c:if>
            </ul>
