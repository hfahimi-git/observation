                        ...
                        $('#lu_province').on('change', function () {
                            ...
                            provinceData[province].forEach(function (item) {
                                $('#cityHolder').append(
                                    ...
                                    (selectedCities.indexOf(item.k) >= 0? 'checked': '')  + ' >' +
                ...
                <div class="form-row mb-3">
                    <div class="col-md-11">
                        <div class="form-group">
                            <label><fmt:message key="languages" /></label><br />
...
<%--------------------------------------------------------------------------------------------------------------------%>
                ...
                <input type="button" class="btn btn-secondary" value="<fmt:message key="cancel" />" onclick="window.location='/${URI_CLASS}?pm_oid=${pmItem.oid}'" />
            ...
            <ul class="col-lg-2 col-md-2 internal-menu internal-menu-default float-right">
                ...
                <c:if test="${URI_METHOD.equals('edit')}">
                <li><a href="/${URI_CLASS}/remove/${pmPeriodItem.oid}?pm_oid=${pmItem.oid}"><fmt:message key="remove" /></a></li>
