...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-10 col-lg-10 px-4 rtl">
            ...
            <form:form action="" method="post" enctype="multipart/form-data" modelAttribute="pmItem"
                ...
                <div class="form-row mb-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <form:select path="luTitle" id="lu_title" cssClass="form-control custom-select"
                                     cssErrorClass="form-control custom-select is-invalid"
                        items="${titleItems}" itemLabel="value" itemValue="key" />
...
<%--------------------------------------------------------------------------------------------------------------------%>
                <div class="form-row mb-3">
                    ...
                    <div class="col-md-2">
                        <label for="birth_year"><fmt:message key="birth_year"/></label>
                    ...
                    <div class="col-md-4">
                        ...
                        <c:if test="${URI_METHOD.equals('edit') && not empty pmItem.filename }">
                            <div>
                                <img src="/uploads/${pmItem.filename}" class="img-thumbnail mw80" />
                                <a href="/parliament-member/remove-image/${pmItem.oid}"
