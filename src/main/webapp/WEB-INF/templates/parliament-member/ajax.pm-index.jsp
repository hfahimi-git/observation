...
<div class="modal fade rtl" id="pmModalScrollable" tabindex="-1" role="dialog"
     aria-labelledby="pmModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog  modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"
                    id="pmModalScrollableTitle"><fmt:message key="do_select" /></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="form ajax-pm-search-form" action="">
