...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-10 col-lg-10 px-4 rtl">
            ...
            <form:form action="" method="post" modelAttribute="boardItem" cssClass="col-lg-10 float-right">
<%--------------------------------------------------------------------------------------------------------------------%>
...
<%--------------------------------------------------------------------------------------------------------------------%>
                <div class="form-row mb-3">
                    <div class="col-md-2">
                        <label for="title"><fmt:message key="observation_count"/></label>
                        <form:input type="text" path="observationCount" id="observation_count" required="required"
                                    cssClass="form-control" cssErrorClass="form-control is-invalid" />
...
<%--------------------------------------------------------------------------------------------------------------------%>
            ...
            <ul class="col-lg-2 col-md-2 internal-menu internal-menu-default float-right">
                ...
                <li><a href="${CONTEXT}/board-period?board_oid=${boardItem.oid}"><fmt:message key="board-periods" /></a></li>
                </c:if>
            </ul>
